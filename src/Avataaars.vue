   ...
   computed: {
     cssVars () {
       return {
         ...
         '--avataaar-hat-color': this.accessoriesColor === 'random' ? this.getRandomChoice(this.clotheColors) : this.clotheColors[this.accessoriesColor],
         '--avataaar-shirt-color': this.clotheColor === 'random' ? this.getRandomChoice(this.clotheColors) : this.clotheColors[this.clotheColor]
       }
     }
   }
}
